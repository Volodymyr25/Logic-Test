...
class Last(Screen):
    def __init__(self, **kwargs):
        ...
        lab_q5 = Label(text = 'Дякую за проходження тесту.Якщо ви дійшли до цього вікна, то у вас хороша логіка :)\n Бажаєте пройти ще раз?', size_hint = (0.2, 0.15), pos_hint ={'y':0.50, "x":0.4})
        line = FloatLayout()
        but_for_start = Button(text = "Початок", size_hint = (0.2, 0.15), pos_hint ={'y':0.17, "x":0.4}, background_color = (0.3, 0.7, 0.5))
